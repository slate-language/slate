...
|---|---|---|
| 2026-09-22 | [2026-09-22 — sysl 0.0.124: `Buf.push` inlines outright for a counted element](results/2026-09-22-sysl-0-0-124.md) | -2.08% geometric mean against sysl 0.0.123, same dev commit; new position 3.4x/2.6x/1.8x/2.2x |
