...
|---|---|---|
| — | ~~**Inline the four superinstruction arms**~~ (profile 3's item 1) | **DONE and it should be UNDONE.** It measured −1.96% against a compiler that had not yet inlined `Buf.push`, and measures **+1.19%** against the one that has. See item 1 |
