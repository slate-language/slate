...
of PCRE2 constructs a browser has nothing to mean — all of them things a JavaScript host genuinely does
not have, and `docs/reference/javascript.md` measures why.
